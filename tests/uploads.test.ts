import fs from 'fs';
import type { ResponseLike } from 'authelete-3.0/internal/to-file';
import { toFile } from 'authelete-3.0/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('authelete-3.0/core/uploads');
    await expect(
